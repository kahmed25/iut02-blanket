    ...
    return (
      <>
        ...
        <div className="min-h-screen bg-gray-50">
          ...
          {/* Hero Section - Clean Indigo theme */}
          <div className="hero-gradient relative overflow-hidden">
            <div className="absolute inset-0 opacity-20">
              <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-indigo-400 rounded-full blur-3xl"></div>
              <div className="absolute bottom-1/4 right-1/4 w-64 h-64 bg-violet-400 rounded-full blur-3xl"></div>
            </div>

            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-24 sm:pt-20 sm:pb-32">
              <div className="text-center">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            {/* About Section - Light cards */}
            <div className="grid md:grid-cols-2 gap-10 items-center mb-16">
              <div>
                <span className="badge badge-info mb-4">About Us</span>
                <h2 className="text-3xl font-bold text-gray-900 mb-5">
                  Making a Real Impact in Our Community
                </h2>
                <p className="text-gray-600 leading-relaxed mb-4">
                  IUT02 Care is a community-driven charity platform managed by the alumni of IUT Batch 02.
                  We believe in the power of collective giving to transform lives.
                </p>
                <p className="text-gray-600 leading-relaxed">
                  From providing blankets during harsh winters to supporting those in need,
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="card p-5">
                  ...
                  <p className="text-sm text-gray-500">Every taka tracked</p>
                </div>
                <div className="card p-5">
                  ...
                  <p className="text-sm text-gray-500">Built by alumni</p>
                </div>
                <div className="card p-5">
                  ...
                  <h3 className="font-semibold text-gray-900 mb-1">Efficient</h3>
                ...
                <div className="card p-5">
                  ...
                  <h3 className="font-semibold text-gray-900 mb-1">Impactful</h3>
                  <p className="text-sm text-gray-500">Real change</p>
                </div>
              </div>
            </div>
            ...
            {projects.length === 0 ? (
              <div className="card p-12 text-center">
                ...
                <p className="text-gray-500 mb-6">Get started by creating your first charity project</p>
          ...
          <footer className="bg-gray-900 text-white py-12 mt-16">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="grid md:grid-cols-3 gap-8">
                <div>
                  <h3 className="text-xl font-bold mb-4">IUT02 Care</h3>
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    Reach out to the IUT02 community administrators for support.
                  </p>
                </div>
              </div>
              <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-500 text-sm">
                © {new Date().getFullYear()} IUT02 Care. Built with care by IUT Batch 02.
              </div>
            </div>
          </footer>
        </div>
