            ...
            <div className="hero-gradient px-6 py-6">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  {project.description && (
                    <div className="text-indigo-200 mt-1 text-sm max-w-2xl">
                      <span>
                      ...
                      {project.description.length > 100 && (
                        <button
                          ...
                          className="ml-2 text-teal-300 hover:text-teal-200 underline cursor-pointer"
                        >
                          Read more
                        </button>
                      )}
                ...
                <span className={`px-3 py-1 text-xs font-semibold rounded-full ${
                  project.status === 'active' ? 'bg-teal-500/20 text-teal-300 border border-teal-400/30' :
                  project.status === 'completed' ? 'bg-sky-500/20 text-sky-300 border border-sky-400/30' :
                  project.status === 'paused' ? 'bg-amber-500/20 text-amber-300 border border-amber-400/30' :
              ...
              <div className="grid grid-cols-4 gap-4 mt-6">
                <div className="bg-white/10 rounded-lg p-3 text-center">
                  ...
                  <p className="text-indigo-300 text-xs uppercase tracking-wide mt-1">Progress</p>
                </div>
                <div className="bg-white/10 rounded-lg p-3 text-center">
                  <p className="text-2xl font-bold text-teal-300">৳{formatExact(stats?.total_raised || 0)}</p>
                  <p className="text-indigo-300 text-xs uppercase tracking-wide mt-1">Collected</p>
                </div>
                <div className="bg-white/10 rounded-lg p-3 text-center">
                  <p className="text-2xl font-bold text-white">৳{formatExact(project.target_amount)}</p>
                  <p className="text-indigo-300 text-xs uppercase tracking-wide mt-1">Target</p>
                </div>
                <div className="bg-white/10 rounded-lg p-3 text-center">
                  <p className="text-2xl font-bold text-white">{stats?.total_contributions || 0}</p>
                  <p className="text-indigo-300 text-xs uppercase tracking-wide mt-1">Donations</p>
                </div>
              </div>
                ...
                <div className="space-y-8">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                    <div className="bg-teal-50 rounded-xl p-4 border border-teal-100">
                      <p className="text-2xl md:text-3xl font-bold text-teal-600">৳{formatExact(stats?.total_raised || 0)}</p>
                      <p className="text-sm text-teal-700 mt-1">Total Collected</p>
                    </div>
                  ...
                  <div className="bg-gradient-to-r from-slate-800 via-slate-900 to-slate-800 rounded-2xl p-6 text-white">
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      <div className="text-center">
                        <p className="text-3xl font-bold text-teal-400">৳{formatExact(stats?.total_raised || 0)}</p>
                  ...
                  <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div className="p-6">
                      <div className="grid grid-cols-3 gap-6 mb-6">
                        <div className="text-center">
                          <p className="text-2xl font-bold text-green-600">৳{formatExact(stats?.total_raised || 0)}</p>
                          <p className="text-gray-500 text-sm mt-1">Raised</p>
                        </div>
                        <div className="text-center border-x border-gray-100">
                          <p className="text-2xl font-bold text-gray-900">৳{formatExact(project.target_amount)}</p>
                          <p className="text-gray-500 text-sm mt-1">Goal</p>
                        </div>
                        <div className="text-center">
                  ...
                  <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <p className="text-2xl font-bold text-gray-900">{stats?.unique_contributors || 0}</p>
                          <p className="text-gray-500">people have contributed to this campaign</p>
                        </div>
                      </div>
                      <button
                        onClick={() => setActiveTab('contributions')}
                        className="px-5 py-2.5 text-sm font-medium text-white bg-teal-600 hover:bg-teal-700 rounded-lg shadow-sm hover:shadow-md transition-all"
                      >
                        View Contributions
                      </button>
                    </div>
                            ...
                            <tr key={contribution.contribution_id} className="border-b border-gray-100 hover:bg-gray-50">
                              <td className="py-4 px-4">
                                <div className="flex items-center">
                                  <div className="w-8 h-8 bg-teal-600 rounded-full flex items-center justify-center text-white font-medium mr-3">
                              ...
                              <td className="py-4 px-4">
                                <span className="font-semibold text-teal-600">৳{formatExact(contribution.amount)}</span>
                              </td>
                              <td className="py-4 px-4">
                              ...
                              <td className="py-4 px-4">
                                <span className={`px-2 py-1 text-xs rounded-full ${
                                  contribution.payment_status === 'completed' ? 'bg-teal-100 text-teal-700' :
                      ...
                      {fundAdmins.map((user) => (
                        ...
                        >
                          ...
                          <div>
                            ...
                            <span className="inline-block mt-1 px-2 py-0.5 text-xs bg-teal-100 text-teal-700 rounded-full">
                              Fund Admin
                            </span>
                          </div>
                        </div>
