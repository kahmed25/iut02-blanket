                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl border border-gray-200">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <p className="text-gray-900 font-medium">Two-Factor Auth</p>
                        <p className="text-gray-500 text-sm">Extra security layer</p>
                      </div>
                    </div>
                    <button className="px-4 py-2 bg-slate-800 text-white rounded-lg hover:bg-slate-700 transition-colors">Enable</button>
                  </div>
                </div>
              </div>
            )}
