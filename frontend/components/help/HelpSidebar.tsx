...
const helpNavItems: HelpNavItem[] = [
  ...
  },
  {
    ...
    description: 'Managing charity projects',
  },
  {
    label: 'Contributions',
    ...
    description: 'Tracking donations',
  },
  {
    label: 'Distributions',
    ...
    description: 'Fund distribution tracking',
  },
  {
    label: 'Media',
    href: '/help/media',
  ...
  },
  {
    ...
    description: 'User roles explained',
  },
];
        ...
        {helpNavItems.map((item) => {
          ...
          return (
            <Link
              key={item.href}
              href={item.href}
              className={`flex items-start p-3 rounded-lg mb-1 transition-colors ${
                isActive
                  ? 'bg-emerald-50 text-emerald-700'
                  : 'text-gray-700 hover:bg-gray-50'
              }`}
            >
              <span className={`mt-0.5 ${isActive ? 'text-emerald-600' : 'text-gray-400'}`}>
                {item.icon}
              </span>
              <div className="ml-3">
